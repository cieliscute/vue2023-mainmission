...
function RainyDay(options) {
  ...
  var src =
    typeof options.image === 'string' ? document.getElementById(options.image) : options.image
...
RainyDay.prototype.initialize = function (options) {
  var sourceParent =
    this.imgSource || options.parentElement || document.getElementsByTagName('body')[0]
