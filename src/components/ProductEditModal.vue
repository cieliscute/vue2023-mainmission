            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-8">
                <div class="mb-3">
                  ...
                  <VField id="title" type="text" class="form-control" placeholder="請輸入標題"
                ...
                <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <VField id="category" type="text"
                    class="form-control" placeholder="請輸入分類"
                    v-model="productData.category"
                    rules="required" name="category"
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <VField id="unit" type="text" class="form-control" placeholder="請輸入單位"
                    v-model="productData.unit"
                    rules="required" name="unit"
